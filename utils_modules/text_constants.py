...
class CopyrightCondition(str, Enum):
    ...
    # Other notices used in this module
...
class AdditionalClassificationCondition(str, Enum):
    # Warning conditions
    FirstEditionNotAWork = 'FirstEditionNotAWork'
...
COPYRIGHT_CC_LICENSE_EXPLANATIONS: Dict[str, str] = {
    ...
    'cc_by_nc_sa': 'Even if the work is protected by copyright, it is available under CC-BY-NC-SA. Additional verification may be needed due to the ShareAlike and NonCommercial requirements.',
    ...
    'cc_by_nc_nd': 'Even if the work is protected by copyright, it is available under CC-BY-NC-ND. Additional verification may be needed due to the Non-Derivative and NonCommercial requirements.',
...
COPYRIGHT_RIGHTS_EXPLANATIONS: Dict[str, str] = {
    'license_agreement': 'Even if the work is protected by copyright, you have acquired the necessary rights through license to make it available online and allow others to use or modify it.',
    ...
    'orphan_works': 'Even if the work is protected by copyright, you may be allowed to make it available online based on provisions concerning orphan works. However, additional verification is necessary due to the specific requirements that apply in such cases.',
    'out_of_commerce': 'Even if the work is protected by copyright, you may be allowed to make it available online based on provisions on out-of-commerce works. However, additional verification is necessary due to the specific requirements that apply in such cases..',
    'quote_right': 'Even if the work is protected by copyright, you may be allowed to make it available online based on the right to quote. However, additional verification is needed due to the specific requirements that apply in such cases.',
    'other_law': 'Even if the work is protected by copyright, you may be allowed to make it available online based on legal provisions. However, additional verification is needed.'
}
...
PERFORMANCE_CC_LICENSE_EXPLANATIONS: Dict[str, str] = {
    ...
    'cc_by_nc_sa': 'Even if the performance is protected, it is available under CC-BY-NC-SA. Additional verification may be needed due to the ShareAlike and NonCommercial requirements.',
    ...
    'cc_by_nc_nd': 'Even if the performance is protected, it is available under CC-BY-NC-ND. Additional verification may be needed due to the Non-Derivative and NonCommercial requirements.',
...
PERFORMANCE_RIGHTS_EXPLANATIONS: Dict[str, str] = {
    'license_agreement': 'Even if the performance is protected by performance rights, you have acquired the necessary rights through license to make it available online and allow others to use or modify it.',
    ...
    'orphan_works': 'Even if the performance is protected by performance rights, you may be allowed to make it available online based on provisions concerning orphan works. However, additional verification is necessary due to the specific requirements that apply in such cases.',
    'out_of_commerce': 'Even if the performance is protected by performance rights, you may be allowed to make it available online based on provisions on out-of-commerce works. However, additional verification is necessary due to the specific requirements that apply in such cases..',
    'quote_right': 'Even if the performance is protected by performance rights, you may be allowed to make it available online based on the right to quote. However, additional verification is needed due to the specific requirements that apply in such cases',
    'other_law': 'Even if the performance is protected by performance rights, you may be allowed to make it available online based on legal provisions. However, additional verification is needed.'
}
...
PHONOGRAM_CC_LICENSE_EXPLANATIONS: Dict[str, str] = {
    ...
    'cc_by_nc_sa': 'Even if the recording is protected, it is available under CC-BY-NC-SA. Additional verification may be needed due to the ShareAlike and NonCommercial requirements.',
    ...
    'cc_by_nc_nd': 'Even if the recording is protected, it is available under CC-BY-NC-ND. Additional verification may be needed due to the Non-Derivative and NonCommercial requirements.',
...
PHONOGRAM_RIGHTS_EXPLANATIONS: Dict[str, str] = {
    ...
    'orphan_works': 'Even if the recording is protected by phonogram rights, you may be allowed to make it available online based on provisions concerning orphan works. However, additional verification is necessary due to the specific requirements that apply in such cases.',
    'out_of_commerce': 'Even if the recording is protected by phonogram rights, you may be allowed to make it available online based on provisions on out-of-commerce works. However, additional verification is necessary due to the specific requirements that apply in such cases..',
    'quote_right': 'Even if the recording is protected by phonogram rights, you may be allowed to make it available online based on the right to quote. However, additional verification is needed due to the specific requirements that apply in such cases',
    'other_law': 'Even if the recording is protected by phonogram rights, you may be allowed to make it available online based on legal provisions. However, additional verification is needed.'
}
...
FILM_FIXATION_CC_LICENSE_EXPLANATIONS: Dict[str, str] = {
    ...
    'cc_by_nc_sa': 'Even if the film fixation is protected, it is available under CC-BY-NC-SA. Additional verification may be needed due to the ShareAlike and NonCommercial requirements.',
    ...
    'cc_by_nc_nd': 'Even if the film fixation is protected, it is available under CC-BY-NC-ND. Additional verification may be needed due to the Non-Derivative and NonCommercial requirements.',
...
FILM_FIXATION_RIGHTS_EXPLANATIONS: Dict[str, str] = {
    'license_agreement': 'Even if the film fixation is protected by film fixation rights, you have acquired the necessary rights through license to make it available online and allow others to use or modify it.',
    ...
    'orphan_works': 'Even if the film fixation is protected by film fixation rights, you may be allowed to make it available online based on provisions concerning orphan works. However, additional verification is necessary due to the specific requirements that apply in such cases.',
    'out_of_commerce': 'Even if the film fixation is protected by film fixation rights, you may be allowed to make it available online based on provisions on out-of-commerce works. However, additional verification is necessary due to the specific requirements that apply in such cases..',
    'quote_right': 'Even if the film fixation is protected by film fixation rights, you may be allowed to make it available online based on the right to quote. However, additional verification is needed due to the specific requirements that apply in such cases',
    'other_law': 'Even if the film fixation is protected by film fixation rights, you may be allowed to make it available online based on legal provisions. However, additional verification is needed.'
}
...
BROADCAST_CC_LICENSE_EXPLANATIONS: Dict[str, str] = {
    ...
    'cc_by_nc_sa': 'Even if the broadcast is protected, it is available under CC-BY-NC-SA. Additional verification may be needed due to the ShareAlike and NonCommercial requirements.',
    ...
    'cc_by_nc_nd': 'Even if the broadcast is protected, it is available under CC-BY-NC-ND. Additional verification may be needed due to the Non-Derivative and NonCommercial requirements.',
...
BROADCAST_RIGHTS_EXPLANATIONS: Dict[str, str] = {
    'license_agreement': 'Even if the broadcast is protected by broadcasting organisation rights, you have acquired the necessary rights through license to make it available online and allow others to use or modify it.',
    ...
    'orphan_works': 'Even if the broadcast is protected by broadcasting organisation rights, you may be allowed to make it available online based on provisions concerning orphan works. However, additional verification is necessary due to the specific requirements that apply in such cases.',
    'out_of_commerce': 'Even if the broadcast is protected by broadcasting organisation rights, you may be allowed to make it available online based on provisions on out-of-commerce works. However, additional verification is necessary due to the specific requirements that apply in such cases..',
    'quote_right': 'Even if the broadcast is protected by broadcasting organisation rights, you may be allowed to make it available online based on the right to quote. However, additional verification is needed due to the specific requirements that apply in such cases',
    'other_law': 'Even if the broadcast is protected by broadcasting organisation rights, you may be allowed to make it available online based on legal provisions. However, additional verification is needed.'
}
...
DIGITAL_REPRESENTATION_CC_LICENSE_EXPLANATIONS: Dict[str, str] = {
    ...
    'cc_by_nc_sa': 'Even if the digital representation is protected by {right_label}, it is available under CC-BY-NC-SA. Additional verification may be needed due to the ShareAlike and NonCommercial requirements.',
    ...
    'cc_by_nc_nd': 'Even if the digital representation is protected by {right_label}, it is available under CC-BY-NC-ND. Additional verification may be needed due to the Non-Derivative and NonCommercial requirements.',
...
DIGITAL_REPRESENTATION_RIGHTS_EXPLANATIONS: Dict[str, str] = {
    'license_agreement': 'Even if the digital representation is protected by {right_label}, you have acquired the necessary rights through license to make it available online and allow others to use or modify it.',
    ...
    'orphan_works': 'Even if the digital representation is protected by {right_label}, you may be allowed to make it available online based on provisions concerning orphan works. However, additional verification is necessary due to the specific requirements that apply in such cases.',
    'out_of_commerce': 'Even if the digital representation is protected by {right_label}, you may be allowed to make it available online based on provisions on out-of-commerce works. However, additional verification is necessary due to the specific requirements that apply in such cases..',
    'quote_right': 'Even if the digital representation is protected by {right_label}, you may be allowed to make it available online based on the right to quote. However, additional verification is needed due to the specific requirements that apply in such cases',
    'other_law': 'Even if the digital representation is protected by {right_label}, you may be allowed to make it available online based on legal provisions. However, additional verification is needed.',
}
