...
from utils import calculate_all_intermediate_values, calculate_results, calculate_intermediate_values_copyright
...
class TestCopyrightCalculations(unittest.TestCase):
    ...
    def test_online_availability_status(self):
        ...
        data = data.copy()
        data['copyright_info']['object_copyright_rights_acquired_to_make_available'] = 'rights_assignment'
        ...
        data = data.copy()
        data['copyright_info']['object_copyright_rights_acquired_to_make_available'] = 'license_agreement'
        results = run_calc(data)
        ...
        data = data.copy()
        data['copyright_info']['object_copyright_rights_acquired_to_make_available'] = 'orphan_works'
        results = run_calc(data)
        ...
        data = data.copy()
        data['copyright_info']['object_copyright_rights_acquired_to_make_available'] = 'not_applicable'
        results = run_calc(data)
        ...
        data = data.copy()
        data['copyright_info']['object_copyright_rights_acquired_to_make_available'] = 'unknown'
        results = run_calc(data)
        ...
        data = data.copy()
        data['copyright_info']['object_copyright_rights_acquired_to_make_available'] = 'out_of_commerce'
        results = run_calc(data)
        ...
        data = data.copy()
        data['copyright_info']['object_copyright_rights_acquired_to_make_available'] = 'no'
        results = run_calc(data)
    ...
    def test_cc_license_status(self):
        ...
        data['copyright_info']['object_cc_license'] = 'cc_by_sa'  # Should make it YELLOW
        data['copyright_info']['object_copyright_rights_acquired_to_make_available'] = 'license_agreement'  # Should then make it GREEN
        results = run_calc(data)
