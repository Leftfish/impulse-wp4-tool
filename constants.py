...
COLLECTION_CHOICES = [
    ...
    ("ju_slub_other", "Jagiellonian University: Other"),
    ...
    ("thessaloniki_other", "Thessaloniki Festival: Other"),
    ("europeana", "Europeana"),
    ("wikidata", "Wikidata"),
    ("other", "Other"),
]
