...
PRESS_PUBLICATION_YEAR_LABEL = 'If the object is a press publication, when was it published?'
PRESS_PUBLICATION_YEAR_DESCRIPTION = 'Enter a four-digit year value.'

TRADEMARK_LABEL = 'Was the object registerd as a trademark OR does it depict a trademark?'
...
SECTION_AUTHOR_INFO_DESCRIPTION = (
    'Depending on the situation, information about the author may be necessary to determine if the work passed into the public domain.'
)

SECTION_CREATION_PUBLICATION_TITLE = 'Creation and Publication Description'
SECTION_CREATION_PUBLICATION_DESCRIPTION = (
    'Depending on the situation, information about whether the work was published or otherwise made available to the public, as well as when it was created, may be necessary to determine if the work has passed into the public domain.'
)

SECTION_PUBLICATION_DATES_TITLE = 'Publication Dates Description'
SECTION_PUBLICATION_DATES_DESCRIPTION = (
    'Note the difference between publication (that implies a material copy) and other forms of making the work publically available.'
)
...
SECTION_DIGITAL_REPR_DESCRIPTION = (
    'We assume, to simplify the evaluation, that none of the digital representations that are practically usable as of 2025 and have ever been covered by any IP rights have passed into the public domain due to the lapse of such rights.'
)

SECTION_IP_RIGHTS_COVERAGE_TITLE = 'IP Rights Coverage Description'
SECTION_IP_RIGHTS_COVERAGE_DESCRIPTION = (
    'Depending on the situation, a digital representation may be protected by various rights at the same time.'
)
...
SECTION_OBJECT_RESTRICTIONS_TITLE = 'Object Restrictions and Legal Consultation Description'
SECTION_OBJECT_RESTRICTIONS_DESCRIPTION = (
    'This section covers contractual and administrative restrictions that may limit the scope of use of the object, as well as legal consultation status.'
)
